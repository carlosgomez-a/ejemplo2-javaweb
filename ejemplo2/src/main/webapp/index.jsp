...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <!-- Bootstrap 5 para estilos y componentes responsivos (Ajustable a diferentes dispositivos)-->
<link
...
h1 {
 ...
 /* Animación al pasar el mouse sobre formularios */
form {
...
<body class="bg-light">
	...
	<div class="container py-5">
        ...
        <!-- Se envía al servlet ClienteServlet mediante el metodo POST -->
		<form action="ClienteServlet" method="post"
		  ...
		  <!-- Formulario de getión de clientes -->
        <!-- Permite eliminar o actualizar un cliente por cédula -->
		<form method="post" class="mb-5 p-4 bg-white rounded shadow-sm">
			<h5 class="mb-3">Gestión de Cliente</h5>
			<div class="mb-3">
				<label for="cedulaCliente" class="form-label">Cédula del
					Cliente:</label> <input type="number" name="cedula" id="cedulaCliente"
		...
		<!-- botones que envian a las respectivas clases jsp de enviar correo y consultar clientes para
		que se realicen las acciones correspondientas-->

				<div class="text-center mt-3">
					<a href="EnviarCorreo.jsp" class="btn btn-info">Enviar Email</a> <a
						href="ConsultarCliente.jsp" class="btn btn-primary">Consultar Cliente</a>
				</div>
			</form>
